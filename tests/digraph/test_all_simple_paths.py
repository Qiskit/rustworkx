...
class TestDAGAllSimplePathsAllPairs(unittest.TestCase):
    ...
    def test_all_simple_paths(self):
        ...
        expected = {
            ...
            3: {
                2: [[3, 4, 5, 2], [3, 4, 2], [3, 2]],
                3: [[3, 4, 5, 3], [3, 4, 5, 2, 3], [3, 4, 2, 3], [3, 2, 4, 5, 3], [3, 2, 3]],
                4: [[3, 4], [3, 2, 4]],
                5: [[3, 4, 5], [3, 2, 4, 5]],
            },
            4: {
            ...
            5: {
                ...
                5: [[5, 3, 4, 5], [5, 3, 2, 4, 5], [5, 2, 4, 5], [5, 2, 3, 4, 5]],
            },
        }
    ...
    def test_all_simple_paths_with_cutoff(self):
        ...
        expected = {
            ...
            4: {
                2: [[4, 5, 3, 2], [4, 5, 2], [4, 2]],
                3: [[4, 5, 3], [4, 5, 2, 3], [4, 2, 3]],
                4: [[4, 5, 3, 4], [4, 5, 2, 4], [4, 2, 4], [4, 2, 3, 4]],
                5: [[4, 5]],
            },
            5: {
                2: [[5, 3, 4, 2], [5, 3, 2], [5, 2]],
    ...
    def test_all_simple_paths_with_min_depth_and_cutoff(self):
        ...
        expected = {
            ...
            2: {2: [[2, 4, 5, 3, 2], [2, 3, 4, 5, 2]]},
            3: {3: [[3, 4, 5, 2, 3], [3, 2, 4, 5, 3]]},
            4: {4: [[4, 5, 3, 2, 4], [4, 5, 2, 3, 4]]},
            5: {5: [[5, 3, 2, 4, 5], [5, 2, 3, 4, 5]]},
        }
        self.assertEqual(expected, paths)
