...
class TestNodes(unittest.TestCase):
    ...
    def test_remove_nodes_retain_edges_single_edge(self):
        ...
        node_c = graph.add_node('c')
        graph.add_edge(node_b, node_c, "Edgy_mk2")
        graph.remove_node_retain_edges(node_b)
        res = graph.nodes()
        self.assertEqual(['a', 'c'], res)
        self.assertEqual([0, 2], graph.node_indexes())
        self.assertTrue(graph.has_edge(node_a, node_c))
    ...
    def test_remove_nodes_retain_edges_multiple_in_edges(self):
        ...
        node_c = graph.add_node('c')
        graph.add_edge(node_b, node_c, "Edgy_mk2")
        graph.add_edge(node_d, node_b, "Multiple in edgy")
        graph.remove_node_retain_edges(node_b)
        res = graph.nodes()
        self.assertEqual(['a', 'd', 'c'], res)
        self.assertEqual([0, 1, 3], graph.node_indexes())
        self.assertTrue(graph.has_edge(node_a, node_c))
        self.assertTrue(graph.has_edge(node_d, node_c))
    ...
    def test_remove_nodes_retain_edges_multiple_out_edges(self):
        ...
        node_c = graph.add_node('c')
        graph.add_edge(node_b, node_c, "Edgy_mk2")
        graph.add_edge(node_b, node_d, "Multiple out edgy")
        graph.remove_node_retain_edges(node_b)
        res = graph.nodes()
        self.assertEqual(['a', 'd', 'c'], res)
        self.assertEqual([0, 1, 3], graph.node_indexes())
        self.assertTrue(graph.has_edge(node_a, node_c))
        self.assertTrue(graph.has_edge(node_a, node_d))
    ...
    def test_remove_nodes_retain_edges_multiple_in_and_out_edges(self):
        ...
        graph.add_edge(node_b, node_c, "Edgy_mk2")
        graph.add_edge(node_b, node_d, "Multiple out edgy")
        graph.add_edge(node_e, node_b, "multiple in edgy")
        graph.remove_node_retain_edges(node_b)
        res = graph.nodes()
        self.assertEqual(['a', 'd', 'e', 'c'], res)
        self.assertEqual([0, 1, 2, 4], graph.node_indexes())
        self.assertTrue(graph.has_edge(node_a, node_c))
        self.assertTrue(graph.has_edge(node_a, node_d))
        self.assertTrue(graph.has_edge(node_e, node_c))
        self.assertTrue(graph.has_edge(node_e, node_d))
    ...
    def test_remove_nodes_retain_edges_with_invalid_index(self):
        ...
        node_c = graph.add_node('c')
        graph.add_edge(node_b, node_c, "Edgy_mk2")
        graph.remove_node_retain_edges(76)
        res = graph.nodes()
        self.assertEqual(['a', 'b', 'c'], res)
        self.assertEqual([0, 1, 2], graph.node_indexes())
