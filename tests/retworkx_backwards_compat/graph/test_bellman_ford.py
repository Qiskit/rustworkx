...
class TestBellmanFordGraph(unittest.TestCase):
    ...
    def test_bellman_all_pair_path_lengths(self):
        lengths = retworkx.all_pairs_bellman_ford_path_lengths(self.graph, float)
        expected = {
    ...
    def test_bellman_ford_all_pair_paths(self):
        paths = retworkx.graph_all_pairs_bellman_ford_shortest_paths(self.graph, float)
        expected = {
            0: {
                1: [0, 1],
                2: [0, 2],
    ...
    def test_bellman_ford_all_pair_path_lengths_with_node_removal(self):
        ...
        lengths = retworkx.graph_all_pairs_bellman_ford_path_lengths(self.graph, float)
        expected = {
    ...
    def test_bellman_ford_all_pair_path_lengths_empty_graph(self):
        graph = retworkx.PyGraph()
        self.assertEqual({}, retworkx.graph_all_pairs_bellman_ford_path_lengths(graph, float))

    def test_bellman_ford_all_pair_shortest_paths_empty_graph(self):
        graph = retworkx.PyGraph()
        self.assertEqual({}, retworkx.graph_all_pairs_bellman_ford_shortest_paths(graph, float))
    ...
    def test_bellman_ford_all_pair_path_lengths_graph_no_edges(self):
        ...
        self.assertEqual(
            expected,
            retworkx.graph_all_pairs_bellman_ford_path_lengths(graph, float),
        )
    ...
    def test_bellman_ford_all_pair_shortest_paths_no_edges(self):
        ...
        self.assertEqual(
            expected,
            retworkx.graph_all_pairs_bellman_ford_shortest_paths(graph, float),
        )
