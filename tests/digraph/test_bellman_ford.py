...
class TestBellmanFordDiGraph(unittest.TestCase):
    ...
    def test_bellman_ford_all_pair_path_lengths(self):
        lengths = retworkx.digraph_all_pairs_bellman_ford_path_lengths(self.graph, float)
        expected = {
    ...
    def test_bellman_ford_all_pair_paths(self):
        paths = retworkx.digraph_all_pairs_bellman_ford_shortest_paths(self.graph, float)
        expected = {
    ...
    def test_bellman_ford_all_pair_paths_with_node_removal(self):
        self.graph.remove_node(3)
        lengths = retworkx.digraph_all_pairs_bellman_ford_shortest_paths(self.graph, float)
        expected = {
    ...
    def test_bellman_ford_all_pair_path_lengths_empty_graph(self):
        graph = retworkx.PyDiGraph()
        self.assertEqual({}, retworkx.digraph_all_pairs_bellman_ford_path_lengths(graph, float))

    def test_bellman_ford_all_pair_shortest_paths_empty_graph(self):
        graph = retworkx.PyDiGraph()
        self.assertEqual({}, retworkx.digraph_all_pairs_bellman_ford_shortest_paths(graph, float))
    ...
    def test_bellman_ford_all_pair_path_lengths_graph_no_edges(self):
        ...
        self.assertEqual(
            expected,
            retworkx.digraph_all_pairs_bellman_ford_path_lengths(graph, float),
        )
    ...
    def test_bellman_ford_all_pair_shortest_paths_no_edges(self):
        ...
        self.assertEqual(
            expected,
            retworkx.digraph_all_pairs_bellman_ford_shortest_paths(graph, float),
        )
    ...
    def test_raises_negative_cycle_all_pairs_bellman_ford_paths(self):
        ...
        with self.assertRaises(retworkx.NegativeCycle):
            retworkx.all_pairs_bellman_ford_shortest_paths(graph, float)
    ...
    def test_raises_negative_cycle_all_pairs_bellman_ford_path_lenghts(self):
        ...
        with self.assertRaises(retworkx.NegativeCycle):
            retworkx.all_pairs_bellman_ford_path_lengths(graph, float)
