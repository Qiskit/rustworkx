...
///     weights will be None if this is specified. If both ``num_nodes`` and
///     ``weights`` are set, this will be ignored and ``weights`` will be used.
/// :param list[S] weights: A list of node weights. The first element in the list
...
/// :param list[S] weights: A list of node weights. Nodes are filled row wise.
...
/// :param list[S] weights: A list of node weights. If the number of weights is
...
/// :param list[S] mesh_weights: A list of node weights for the mesh graph. If both
///     ``num_mesh_nodes`` and ``mesh_weights`` are set, ``num_mesh_nodes`` will
///     be ignored and ``mesh_weights`` will be used.
/// :param list[S] path_weights: A list of node weights for the path. If both
