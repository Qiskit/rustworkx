    ...
    def test_all_simple_paths_min_depth(self):
        ...
        expected = {
            0: {
                ...
                2: [[0, 1, 3, 4, 5, 2], [0, 1, 3, 5, 4, 2], [0, 1, 3, 5, 4, 2]],
                3: [[0, 1, 2, 4, 5, 3], [0, 1, 2, 5, 4, 3], [0, 1, 2, 4, 5, 3]],
                4: [
                    [0, 3, 1, 2, 5, 4],
                    [0, 2, 1, 3, 5, 4],
                    [0, 1, 3, 2, 5, 4],
            ...
            1: {
                ...
                2: [[1, 0, 3, 4, 5, 2], [1, 0, 3, 5, 4, 2], [1, 0, 3, 5, 4, 2]],
                3: [[1, 0, 2, 4, 5, 3], [1, 0, 2, 5, 4, 3], [1, 0, 2, 4, 5, 3]],
                4: [
                    [1, 3, 0, 2, 5, 4],
                    [1, 2, 0, 3, 5, 4],
                    [1, 0, 3, 2, 5, 4],
            ...
            2: {
                0: [[2, 4, 5, 3, 1, 0], [2, 5, 4, 3, 1, 0], [2, 4, 5, 3, 1, 0]],
                1: [[2, 4, 5, 3, 0, 1], [2, 5, 4, 3, 0, 1], [2, 4, 5, 3, 0, 1]],
                2: [
                    [2, 4, 5, 3, 1, 2],
                    [2, 4, 5, 3, 0, 2],
                    [2, 4, 3, 1, 0, 2],
                ...
                4: [[2, 1, 0, 3, 5, 4], [2, 0, 1, 3, 5, 4]],
                5: [[2, 1, 0, 3, 4, 5], [2, 0, 1, 3, 4, 5]],
            },
            3: {
                0: [[3, 4, 5, 2, 1, 0], [3, 5, 4, 2, 1, 0], [3, 5, 4, 2, 1, 0]],
                1: [[3, 4, 5, 2, 0, 1], [3, 5, 4, 2, 0, 1], [3, 5, 4, 2, 0, 1]],
                3: [
                    [3, 4, 5, 2, 1, 3],
                    [3, 4, 5, 2, 0, 3],
                    [3, 4, 2, 1, 0, 3],
                ...
                4: [[3, 1, 0, 2, 5, 4], [3, 0, 1, 2, 5, 4]],
                5: [[3, 1, 0, 2, 4, 5], [3, 1, 0, 2, 4, 5], [3, 0, 1, 2, 4, 5], [3, 0, 1, 2, 4, 5]],
            },
            4: {
                0: [
                    [4, 5, 3, 2, 1, 0],
                ...
                2: [[4, 5, 3, 1, 0, 2], [4, 5, 3, 0, 1, 2]],
                3: [[4, 5, 2, 1, 0, 3], [4, 5, 2, 0, 1, 3]],
                4: [
                    [4, 5, 3, 1, 2, 4],
                    [4, 5, 3, 1, 2, 4],
                    [4, 5, 3, 0, 2, 4],
            ...
            5: {
                ...
                2: [[5, 4, 3, 1, 0, 2], [5, 4, 3, 0, 1, 2]],
                3: [[5, 4, 2, 1, 0, 3], [5, 4, 2, 0, 1, 3], [5, 4, 2, 1, 0, 3], [5, 4, 2, 0, 1, 3]],
                4: [
                    [5, 3, 1, 0, 2, 4],
                    [5, 3, 1, 0, 2, 4],
                    [5, 3, 0, 1, 2, 4],
    ...
    def test_all_simple_paths_with_min_depth_and_cutoff(self):
        ...
        expected = {
            ...
            2: {
                ...
                4: [[2, 1, 3, 5, 4], [2, 1, 0, 3, 4], [2, 0, 3, 5, 4], [2, 0, 1, 3, 4]],
                5: [[2, 1, 3, 4, 5], [2, 1, 0, 3, 5], [2, 0, 3, 4, 5], [2, 0, 1, 3, 5]],
            },
            3: {
                0: [
                    [3, 4, 5, 2, 0],
            ...
            4: {
                ...
                2: [[4, 5, 3, 1, 2], [4, 5, 3, 0, 2], [4, 3, 1, 0, 2], [4, 3, 0, 1, 2]],
                3: [
                    [4, 5, 2, 1, 3],
                    [4, 5, 2, 0, 3],
                    [4, 2, 1, 0, 3],
            ...
            5: {
                ...
                2: [[5, 3, 1, 0, 2], [5, 3, 0, 1, 2], [5, 4, 3, 1, 2], [5, 4, 3, 0, 2]],
                3: [
                    [5, 2, 1, 0, 3],
                    [5, 2, 0, 1, 3],
                    [5, 4, 2, 1, 3],
