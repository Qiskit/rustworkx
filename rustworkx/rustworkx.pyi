...
class PyGraph(Generic[_S, _T]):
    ...
    def subgraph_with_nodemap(self, nodes: Sequence[int], /, preserve_attrs: bool = ...) -> tuple[PyGraph[_S, _T], NodeMap]: ...
...
class PyDiGraph(Generic[_S, _T]):
    ...
    def subgraph_with_nodemap(self, nodes: Sequence[int], /, preserve_attrs: bool = ...) -> tuple[PyDiGraph[_S, _T], NodeMap]: ...
    def substitute_node_with_subgraph(
        self,
        node: int,
        other: PyDiGraph[_S, _T],
