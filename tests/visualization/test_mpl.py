...
class TestMPLDraw(unittest.TestCase):
    ...
    def test_edge_colormap(self):
        ...
        fig = mpl_draw(graph, edge_color=colors, width=4,
    ...
    def test_draw_edges_min_source_target_margins(self):
        ...
        for node_shape in node_shapes:
            with self.subTest(shape=node_shape):
                fig, ax = plt.subplots()
                mpl_draw(graph, pos=pos, ax=ax, node_shape=node_shape,
    ...
    def test_labels_and_colors(self):
        ...
        mpl_draw(graph, pos=pos, node_list=[0, 1, 2, 3], node_color="r",
                 edge_list=[(0, 1), (1, 2), (2, 3), (3, 0)],
                 node_size=500, alpha=0.75, width=1.0,
                 labels=lambda x: labels[x], font_size=16)
        mpl_draw(graph, pos=pos, node_list=[4, 5, 6, 7], node_color="b",
                 node_size=500, alpha=0.5,
                 edge_list=[(4, 5), (5, 6), (6, 7), (7, 4)], width=8,
                 edge_color="r", rotate=False,
