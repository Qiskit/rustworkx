...
class PyDiGraph(Generic[S, T]):
    ...
    def add_edges_from_no_data(self, obj_list: List[Tuple[int, int]], /) -> List[int]: ...
    ...
    def extend_from_edge_list(self, edge_list: List[Tuple[int, int]], /) -> None: ...
    ...
    def insert_node_on_in_edges_multiple(self, node: int, ref_nodes: List[int], /) -> None: ...
    def insert_node_on_out_edges(self, node: int, ref_node: int, /) -> None: ...
    def insert_node_on_out_edges_multiple(self, node: int, ref_nodes: List[int], /) -> None: ...
    ...
    def remove_edges_from(self, index_list: List[Tuple[int, int]], /) -> None: ...
