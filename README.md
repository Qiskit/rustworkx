...
[![Minimum rustc 1.93](https://img.shields.io/badge/rustc-1.93+-blue.svg)](https://rust-lang.github.io/rfcs/2495-min-rust-version.html)
...
from the published source package you need to have Rust >= 1.93 installed (and
