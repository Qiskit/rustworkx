...
![A Petersen graph, a heavy-hexagon graph, and a binomial tree graph visualized the **`retworkx.visualization`** module.\label{fig:graphexample}](paper_img/example_graph.png){ width=100% height==100% }
