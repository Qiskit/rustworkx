...
fn rustworkx(py: Python<'_>, m: &Bound<PyModule>) -> PyResult<()> {
    ...
    m.add_wrapped(wrap_pyfunction!(crate::graph6::read_graph6_str))?;
    m.add_wrapped(wrap_pyfunction!(crate::graph6::write_graph6_from_pygraph))?;
    m.add_wrapped(wrap_pyfunction!(crate::graph6::write_graph6_from_pydigraph))?;
    ...
    m.add_wrapped(wrap_pyfunction!(crate::graph6::digraph_write_graph6_file))?;
