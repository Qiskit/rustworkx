...
def collect_bicolor_runs(
    ...
    filter_fn: Optional[Callable[[_S], bool]] = ...,
    color_fn: Optional[Callable[[_T], int]] = ...,
) -> List[List[_S]]: ...
...
def dag_weighted_longest_path(
    graph: PyDiGraph[_S, _T], weight_fn: Optional[Callable[[int, int, _T], float]] = ...
) -> NodeIndices: ...
...
"""
def digraph_all_pairs_all_simple_paths(*args, **kwargs) -> Any: ...
def digraph_all_pairs_bellman_ford_path_lengths(*args, **kwargs) -> Any: ...
def digraph_all_pairs_bellman_ford_shortest_paths(*args, **kwargs) -> Any: ...
...
def digraph_bellman_ford_shortest_path_lengths(*args, **kwargs) -> Any: ...
def digraph_bellman_ford_shortest_paths(*args, **kwargs) -> Any: ...
def digraph_betweenness_centrality(*args, **kwargs) -> Any: ...
...
def digraph_closeness_centrality(*args, **kwargs) -> Any: ...
...
def digraph_edge_betweenness_centrality(*args, **kwargs) -> Any: ...
def digraph_eigenvector_centrality(*args, **kwargs) -> Any: ...
...
def graph_all_pairs_all_simple_paths(*args, **kwargs) -> Any: ...
def graph_all_pairs_bellman_ford_path_lengths(*args, **kwargs) -> Any: ...
def graph_all_pairs_bellman_ford_shortest_paths(*args, **kwargs) -> Any: ...
...
def graph_bellman_ford_shortest_path_lengths(*args, **kwargs) -> Any: ...
def graph_bellman_ford_shortest_paths(*args, **kwargs) -> Any: ...
def graph_betweenness_centrality(*args, **kwargs) -> Any: ...
...
def graph_closeness_centrality(*args, **kwargs) -> Any: ...
...
def graph_edge_betweenness_centrality(*args, **kwargs) -> Any: ...
def graph_eigenvector_centrality(*args, **kwargs) -> Any: ...
@overload
...
@overload
def minimum_spanning_edges(graph, weight_fn: float) -> Any: ...
@overload
def minimum_spanning_tree(graph, weight_fn) -> Any: ...
@overload
def minimum_spanning_tree(graph, weight_fn: float) -> Any: ...
